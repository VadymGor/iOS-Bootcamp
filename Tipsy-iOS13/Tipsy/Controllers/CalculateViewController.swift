...
class CalculateViewController: UIViewController {
    ...
    @IBAction func tipChanged(_ sender: UIButton) {
        ...
        //  Make the tip button that the user pressed become the selected button and make the others deselected
    ...
    @IBAction func calculatePressed(_ sender: UIButton) {
        ...
        if bill != "" {
            // Turn the bill from a String to an actual String with decimal places
